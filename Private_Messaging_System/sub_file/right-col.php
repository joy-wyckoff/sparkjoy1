...
if (isset($_GET['user'])){
  ...
  WHERE `sender_name` = "'.$_SESSION['username'].'" or `reciever_name` ="'.$_SESSION['username'].'"
  ...
  if($r){
    if(mysqli_num_rows($r)>0){
      ...
      //This user haven't sent any message
...
if($r){
  ...
  while($row=mysqli_fetch_assoc($r)){
    ...
    //check who is sender of the message
